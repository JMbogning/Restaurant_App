...
const ProfileScreen = ({ history }) => {
    ...
    const handleSubmit = (e) => {
        ...
        if (
            ...
            errorsCheck.confirmPassword = "Les mots de passe doivent être les mêmes.";
        }
    ...
    const handleModalSubmit = (e) => {
        ...
        if (!passwordCheck.length) {
            errorsCheck.passwordCheck = "Mot de passe obligatoire.";
        }
    ...
    const renderModalCheckPassword = () => (
        ...
        >
            ...
            <p>
                Pour des raisons de sécurité, veuillez insérer votre mot de passe réel pour confirmer les changements.
            </p>
